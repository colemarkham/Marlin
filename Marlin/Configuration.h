...
#define STRING_CONFIG_H_AUTHOR "Cole Markham, AI Biosciences" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AIBI Rotary PCR"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 200*16/(2*16), 80, 500 }
